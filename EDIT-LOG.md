...
2026-08-02 | 4 - Leader Huddles.dc.html | Page 23 (LGR-02 Asking Better Questions): Chair "Come & Follow" badge REPLACED by Mantra "Catch the Wind" — page still carries 2 badges (Mantra + Rhythm). CD logged this as "added ... ahead of the existing Rhythm tag"; it was a replacement, not an addition. Justin confirmed the replacement is intended. Applied Cowork-side to the live copy (2026-07-16 addendum path) — CD's exported file was NOT used | session: cd-sync-huddles-badge
2026-08-02 | _cd-update/4 - Leader Huddles.dc.html | EXPORT REJECTED. CD's sandbox baseline for booklet 4 is stale by ~30 live edits; pushing it would have reverted: 4 Chair badges + 1 Mantra badge (p.11 "Be With Me", p.21 "Come & Follow", p.23 "Come & Follow", p.25 "Wreck the Roof" + "Come & See"), the Chair 3/4 renames (Be With Me / Remain In Me -> back to Fish for People / Bear Fruit), the "The Four Chairs, Quick" heading, 5 MSM/HSM leader-note tweaks, and several copy fixes. Zero ledger entries for any of it. Next CD session must re-baseline booklet 4 from live before editing it | session: cd-sync-huddles-badge
2026-08-02 | _cd-update/SITE-MANIFEST.md | HELD BACK — export is the 2026-07-26 version; pushing it would erase the hub-relayout notes and the whole group-cards/ section. Repo copy is authoritative | session: cd-sync-huddles-badge
2026-08-02 | _cd-update/8x8 Booklet Template.html | HELD BACK — new file, not in the repo, no ledger entry, reads as sandbox scratch. Confirm with CD before it ever lands | session: cd-sync-huddles-badge
2026-08-02 | lrs-pdf-render.mjs | Added a third page-unit branch: 'pair' (.sc-host > .stage > .stack.spread > .pair > section.page) for booklet 4, which the .pg/.rpage branches never matched — the renderer timed out on it. Also: measure pair-book geometry with offsetWidth/Height (the .stack.spread carries a fit-to-viewport transform:scale, so getBoundingClientRect reported 684px/7.13in instead of 768px/8in), and added .toolbar (booklet 4's Pages/Spreads view toggle) to the nav-hide set alongside #libnav/.viewbar. Strictly additive — .pg and .rpage code paths unchanged | session: cd-sync-huddles-badge
2026-08-02 | pdf/4 - Leader Huddles.dc.pdf | Regenerated from the updated HTML (workflow step 3-1/2): 124 pages, 8x8in, clean mode, photos downsampled to 1800px long edge. Verified: page count, page size, p.23 badge renders "MANTRA CATCH THE WIND / RHYTHM EQUIPPING", all 8 section accents distinct (no --ember collapse) | session: cd-sync-huddles-badge

--- synced to main a12f34d 2026-08-02 (pdf: c7c3ae2) ---
